...
/**
 * Class AuthSchemaPublishCommand
 * @package Ytake\LaravelVoltDB\Console
 * @author yuuki.takezawa<yuuki.takezawa@comnect.jp.net>
 * @license http://opensource.org/licenses/MIT MIT
 */
class AuthSchemaPublishCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'ytake:voltdb-auth-publish';

    /**
     * The console command description.
     * @var string
     */
    protected $description = "publish DDL for auth driver";
    ...
    public function fire()
    {
        ...
        $this->line("<comment>example). $ voltdb voltdb create catalog.ja</comment>");
    }
}
